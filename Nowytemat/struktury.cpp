...
void wyswietlInf(osoba u) {
    cout << setw(10) << left <<"Imie:" << setw(20) << setfill('_')  << right << u.imie << endl;
    cout << setw(10) << left << "Nazwisko:" << setw(20) << right << setfill('_') << u.nazwisko << endl;
    cout << setw(10) << left << "Wiek:" << setw(20) << right << setfill('_') << u.wiek << endl;
}
...
void wyswietlDane(osoba t[], int n) {
    for(int i = 0; i < n; i++) {
        cout << setw(10) << left <<"Imie:" << setw(20) << setfill('_')  << right << t[i].imie << endl;
        cout << setw(10) << left << "Nazwisko:" << setw(20) << right << setfill('_') << t[i].nazwisko << endl;
        cout << setw(10) << left << "Wiek:" << setw(20) << right << setfill('_') << t[i].wiek << endl;
    }
}
